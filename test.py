...
parser.add_argument('--imagenet_model', default='H:\code\Two-branch-dehazing-main\Two-branch-dehazing-main\model', type=str, help='load trained model or not')
...
try:
    MyEnsembleNet.load_state_dict(torch.load( './model/best.pkl'))
    print('--- weight loaded ---')
except:
